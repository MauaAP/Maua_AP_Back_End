...
export class UpdateEventUsecase {
  ...
  async execute(eventId: string, eventProps: EventProps) {
    ...
    // Criar o objeto Event com o ID do evento existente
    const eventToUpdate = new Event({
      ...eventProps,
      eventId: eventId
    });

    const updatedEvent = await this.repo.updateEvent(eventId, eventToUpdate);
    return updatedEvent;
  }
}
